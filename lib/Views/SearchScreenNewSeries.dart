...
class SearchScreenNewSeriesPage extends StatefulWidget {
  ...
  SearchScreenNewSeriesPage({Key key,@required this.video_category}) : super(key: key);
...
class SearchScreenNewSeriesPageState extends State<SearchScreenNewSeriesPage> {
  ...
  Future<SeriesHomeListResponse> getSearchList(String user_Token,String keyword) async {
                    ...
                    Navigator.of(context, rootNavigator: true)
                        ...
                        MaterialPageRoute(
                            builder: (BuildContext context) {
                              return VideoSearchResultSeriesPage(series_id: mainData[index].seriesId.toString(),seriesTitle:mainData[index].seriesTitle);
                            }
                        ))
                  },
                  child:
