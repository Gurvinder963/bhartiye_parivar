      ...
      ..addListener(() {
        if (tabController.indexIsChanging) {
          ...
          if (tabController.index == 0) {
            ...
            eventBusHTC.fire(OnHomeTabChange("social"));
          }
           else if (tabController.index == 10) {
            eventBusHTC.fire(OnHomeTabChange("chat"));
          }
    ...
    return Scaffold(
      ...
      child: DefaultTabController(
        ...
        child: Scaffold(
              ...
              : AppBar(
                  ...
                  flexibleSpace: TabBar(
                    ...
                    tabs: [
                      ...
                      Tab(
                          child: Text(
                        Languages.of(context).Series,
                        style: GoogleFonts.roboto(
                            fontSize: 17, fontWeight: FontWeight.w600),
                      )),
                      Tab(
                          child: Text(
                        Languages.of(context).LiveTag,
                        style: GoogleFonts.roboto(
                            fontSize: 17, fontWeight: FontWeight.w600),
                      )),
                      ...
                      Tab(
                          child: Text(
                        Languages.of(context).Spiritual,
                        style: GoogleFonts.roboto(
                            fontSize: 17, fontWeight: FontWeight.w600),
                      )),
                      Tab(
                      ...
                      Tab(
                          child: Text(
                        Languages.of(context).Culture,
                        style: GoogleFonts.roboto(
                            fontSize: 17, fontWeight: FontWeight.w600),
                      )),
                      Tab(
                          child: Text(
                        Languages.of(context).Conspiracy,
                        style: GoogleFonts.roboto(
                            fontSize: 17, fontWeight: FontWeight.w600),
                      )),
                      Tab(
          ...
          body: TabBarView(
            physics: isFullScreen?NeverScrollableScrollPhysics():AlwaysScrollableScrollPhysics(),
            controller: tabController,
            children: [
              new MainPage(),
              new TrendingPage(),
